edit file flutter_native_splash.yaml in root and after that run

```bash
dart run flutter_native_splash:create --path=D:\hiddify-next-main\g4a4\g4a4\flutter_native_splash.yaml
```
 ** Use a 512x512 or 1024x1024 PNG image.
Usage
...
I see a white screen between splash screen and app
    ...
    It may be caused by the delay due to initialization in your app. To solve this, use the preserve and remove calls to keep the splash on screen while your app initializes.
